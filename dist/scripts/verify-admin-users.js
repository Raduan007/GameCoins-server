...
async function runVerification() {
    ...
    try {
        ...
        let targetUser = await user_model_1.default.findOne({ email: targetEmail });
        if (!targetUser) {
            targetUser = await user_model_1.default.create({
...
runVerification();
//# sourceMappingURL=verify-admin-users.js.map